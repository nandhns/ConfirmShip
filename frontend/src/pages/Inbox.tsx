...
import { emails, inboxFilters } from '../data/emails';
  ...
  return (
    <div className="screen-scroll h-full bg-canvas pb-[86px]">
      <div className="sticky top-0 z-10 bg-canvas/95 px-5 pb-3 pt-2 backdrop-blur">
        <h1 className="text-[24px] font-bold tracking-tight text-navy-900">Inbox</h1>
      ...
      <div className="px-5">
        ...
        <div className="rounded-2xl border border-dashed border-slate-300 bg-white px-5 py-12 text-center">
            <p className="text-[14px] font-semibold text-navy-900">No matching messages</p>
            <p className="mt-1 text-[12.5px] text-muted">Try a different filter or search term.</p>
          </div> :
